...
# 5   9  36   16  4  6   AΓL(1,9)    QD16     4      AΓL(1,9)  2      2           19     1       4       true             false            true             false                6                                
# 6   9  36   20  5  10  AΓL(1,9)    QD16     4      AΓL(1,9)  2      2           19     1       4       true             false            true             false                5                                
# 7   9  36   28  7  21  S9          S8       2xS7   S9        2      2           34     1       3       true             true             true             true                                        complete  
# 8   9  54   24  4  9   AGL(2,3)    GL(2,3)  D8     AGL(2,3)  2      2           26     1       3       true             false            true             false                                                 
# 9   9  54   30  5  15  3^2:(2'A4)  SL(2,3)  4      AGL(2,3)  2      2           23     1       3       true             false            true             false                                                 
# 10  9  72   24  3  6   AGL(2,3)    GL(2,3)  S3     AGL(2,3)  2      2           26     1       2       true             false            true             false                                                 
# 11  9  72   32  4  12  M9          Q8       1      AGL(2,3)  2      2           14     1       2       true             false            false            false                                                 
# 12  9  72   40  5  20  3^2:(2'A4)  SL(2,3)  3      AGL(2,3)  2      2           23     1       4       true             false            false            false                                                 
# 13  9  72   48  6  30  AΓL(1,9)    QD16     2      AGL(2,3)  2      2           19     1       2       true             false            false            false                                                 
# 14  9  84   28  3  7   PΓL(2,8)    2^3:7:3  3xS3   S9        2      2           32     1       1       true             false            true             true                                        complete  
# 15  9  84   56  6  35  A9          A8       A6:S3  S9        2      2           33     1       1       true             true             true             true                                        complete  
# 16  9  126  56  4  21  A9          A8       A5:S4  S9        2      2           33     1       2       true             true             true             true                 17                     complete  
# 17  9  126  70  5  35  A9          A8       A5:S4  S9        2      2           33     1       2       true             true             true             true                 16                     complete  
# ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
# 32  9  36   28  7  21  A9          A8       S7     S9        2      2           33     1       3       true             true             true             true                                        complete  
# 33  9  36   28  7  21  S9          S8       2xS7   S9        2      2           34     1       3       true             true             true             true                                        complete  
...
# 60  9  84   28  3  7   A9          A8       A6:S3  S9        2      2           33     1       1       true             true             true             true                 64                     complete  
# 61  9  84   28  3  7   S9          S8       S6xS3  S9        2      2           34     1       1       true             true             true             true                 65                     complete  
...
# 64  9  84   56  6  35  A9          A8       A6:S3  S9        2      2           33     1       1       true             true             true             true                 60                     complete  
# 65  9  84   56  6  35  S9          S8       S6xS3  S9        2      2           34     1       1       true             true             true             true                 61                     complete  
...
# 68  9  126  56  4  21  A9          A8       A5:S4  S9        2      2           33     1       2       true             true             true             true                 72                     complete  
# 69  9  126  56  4  21  S9          S8       S5xS4  S9        2      2           34     1       2       true             true             true             true                 73                     complete  
...
# 72  9  126  70  5  35  A9          A8       A5:S4  S9        2      2           33     1       2       true             true             true             true                 68                     complete  
# 73  9  126  70  5  35  S9          S8       S5xS4  S9        2      2           34     1       2       true             true             true             true                 69                     complete  
# ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
lD_9 :=  [
 rec( parameters := [ 9, 12, 4, 3, 1 ],
  autGroup := Group( [ (1,2,4,9,6,8,3,7), (1,9,6,4,5,8)(2,3) ] ),
 ...
 rec( parameters := [ 9, 84, 28, 3, 7 ],
  autGroup := Group( [ (1,2,3,4,5,6,7,8,9), (1,2) ] ),
  autSubgroup := Group( [ (1,9,3,5,6,2,7,4,8), (1,9,4,6,3,8)(2,7) ] ),
  groupNumbers := [ 32, 1, 1 ],
  baseBlock := [ 1, 2, 3 ],
  blockSizes := [ 3 ],
  isBinary := true,
...
lD_9_all :=  [
 rec( parameters := [ 9, 12, 4, 3, 1 ],
  autGroup := Group( [ (2,7,5,3,9,4,6,8), (1,4,7)(3,9,6) ] ),
  autSubgroup := Group( [ (1,6,2,3)(4,7,8,5), (1,8,2,4)(3,5,6,7), (1,2,9)(3,4,5)(6,7,8), (1,4,7)(2,5,8)(3,6,9) ] ),
  groupNumbers := [ 14, 1, 1 ],
  baseBlock := [ 1, 2, 9 ],
  blockSizes := [ 3 ],
  ...
  v:= 9),
 rec( parameters := [ 9, 12, 4, 3, 1 ],
  autGroup := Group( [ (2,9)(3,6,4,8,5,7), (1,2,5,3,6,7)(4,9,8), (1,9,7,8)(2,5,6,3) ] ),
  ...
  v:= 9),
 rec( parameters := [ 9, 12, 4, 3, 1 ],
  autGroup := Group( [ (3,4,5)(6,8,7), (1,3,6,5,4,2,8,9) ] ),
  autSubgroup := Group( [ (1,6,4,5,2,3,8,7), (1,2,9)(3,4,5)(6,7,8), (1,4,7)(2,5,8)(3,6,9), (1,2)(3,5)(6,7) ] ),
  groupNumbers := [ 19, 1, 1 ],
  baseBlock := [ 1, 2, 9 ],
  blockSizes := [ 3 ],
 ...
 rec( parameters := [ 9, 12, 4, 3, 1 ],
  ...
  v:= 9),
 rec( parameters := [ 9, 12, 4, 3, 1 ],
  autGroup := Group( [ (1,2,7)(3,4,9)(5,8,6), (1,9,8)(2,4,3)(5,7,6), (3,8)(4,6)(5,7) ] ),
  autSubgroup := Group( [ (3,4,5)(6,8,7), (1,7,6,4,8,2,9,5) ] ),
  groupNumbers := [ 26, 1, 1 ],
  baseBlock := [ 1, 2, 9 ],
  blockSizes := [ 3 ],
 ...
 rec( parameters := [ 9, 18, 8, 4, 3 ],
  ...
  v:= 9),
 rec( parameters := [ 9, 18, 8, 4, 3 ],
  autGroup := Group( [ (2,4,9,7)(3,6,8,5), (1,3,2,6)(4,5,8,7), (2,3)(5,6)(8,9) ] ),
  autSubgroup := Group( [ (1,6,2,3)(4,7,8,5), (1,8,2,4)(3,5,6,7), (1,2,9)(3,4,5)(6,7,8), (1,4,7)(2,5,8)(3,6,9) ] ),
  groupNumbers := [ 14, 1, 3 ],
  baseBlock := [ 1, 2, 3, 4 ],
  blockSizes := [ 4 ],
  ...
  v:= 9),
 rec( parameters := [ 9, 18, 8, 4, 3 ],
  autGroup := Group( [ (1,2,3,5)(4,6,9,7), (1,3,4,2)(5,6,9,8), (1,2)(3,5)(6,7), (1,5)(2,4)(3,9)(7,8) ] ),
  autSubgroup := Group( [ (1,6,4,5,2,3,8,7), (1,2,9)(3,4,5)(6,7,8), (1,4,7)(2,5,8)(3,6,9) ] ),
  groupNumbers := [ 15, 1, 3 ],
  baseBlock := [ 1, 2, 3, 5 ],
  blockSizes := [ 4 ],
  ...
  v:= 9),
 rec( parameters := [ 9, 18, 8, 4, 3 ],
  autGroup := Group( [ (1,2,3,5)(4,6,9,7), (1,4,9,6)(3,5,7,8), (1,2)(3,5)(6,7), (1,4)(2,3)(5,9)(6,8) ] ),
  autSubgroup := Group( [ (1,6,4,5,2,3,8,7), (1,2,9)(3,4,5)(6,7,8), (1,4,7)(2,5,8)(3,6,9), (1,2)(3,5)(6,7) ] ),
  groupNumbers := [ 19, 1, 3 ],
  baseBlock := [ 1, 2, 3, 5 ],
  blockSizes := [ 4 ],
 ...
 rec( parameters := [ 9, 18, 10, 5, 5 ],
  ...
  v:= 9),
 rec( parameters := [ 9, 36, 16, 4, 6 ],
  autGroup := Group( [ (1,3,7,4,5,9,8,2), (1,2,4,3)(5,8,9,6) ] ),
  autSubgroup := Group( [ (1,6,4,5,2,3,8,7), (1,2,9)(3,4,5)(6,7,8), (1,4,7)(2,5,8)(3,6,9) ] ),
  groupNumbers := [ 15, 1, 4 ],
  baseBlock := [ 1, 2, 3, 4 ],
  blockSizes := [ 4 ],
 ...
 rec( parameters := [ 9, 36, 28, 7, 21 ],
  autGroup := Group( [ (1,2,3,4,5,6,7,8,9), (1,2) ] ),
  autSubgroup := Group( [ (1,4)(2,9)(3,7)(6,8), (1,8,4,9,6,7,2,3,5) ] ),
  groupNumbers := [ 27, 1, 3 ],
  baseBlock := [ 1, 2, 3, 4, 5, 6, 7 ],
  blockSizes := [ 7 ],
  isBinary := true,
 ...
 rec( parameters := [ 9, 36, 28, 7, 21 ],
  autGroup := Group( [ (1,2,3,4,5,6,7,8,9), (1,2) ] ),
  autSubgroup := Group( [ (1,4,2,6,3,9,5,7,8), (1,7,3,4,8,9)(2,5) ] ),
  groupNumbers := [ 32, 1, 3 ],
  baseBlock := [ 1, 2, 3, 4, 5, 6, 7 ],
  blockSizes := [ 7 ],
  isBinary := true,
 ...
 rec( parameters := [ 9, 84, 28, 3, 7 ],
  autGroup := Group( [ (1,2,3,4,5,6,7,8,9), (1,2) ] ),
  autSubgroup := Group( [ (1,3,7)(2,9,6)(4,5,8), (1,7,8,3,5,4,9) ] ),
  groupNumbers := [ 27, 1, 1 ],
  baseBlock := [ 1, 2, 3 ],
  blockSizes := [ 3 ],
  isBinary := true,
 ...
 rec( parameters := [ 9, 126, 56, 4, 21 ],
  autGroup := Group( [ (1,2,3,4,5,6,7,8,9), (1,2) ] ),
  autSubgroup := Group( [ (1,5,3,9,8,7,4,2,6), (1,8,7,6,2,5,3,4,9) ] ),
  groupNumbers := [ 27, 1, 2 ],
  baseBlock := [ 1, 2, 3, 4 ],
  blockSizes := [ 4 ],
  isBinary := true,
 ...
 rec( parameters := [ 9, 126, 56, 4, 21 ],
  autGroup := Group( [ (1,2,3,4,5,6,7,8,9), (1,2) ] ),
  autSubgroup := Group( [ (1,4,7,5,8,2,9,3,6), (1,5,9,2,6,3)(4,7) ] ),
  groupNumbers := [ 32, 1, 2 ],
  baseBlock := [ 1, 2, 3, 4 ],
  blockSizes := [ 4 ],
  isBinary := true,
