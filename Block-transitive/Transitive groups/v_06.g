...
# --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
# 1   6  10  5   3  2  PSL(2,5)  D10  S3     PSL(2,5)  2      2           12     1       1       true             true             true             true                                                  
# 2   6  15  10  4  6  A6        A5   S4     S6        2      2           15     1       2       true             true             true             true                                        complete  
...
# --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
# 1   6  10  5   3  2  PSL(2,5)  D10  S3     PSL(2,5)  2      2           12     1       1       true             true             true             true                                                  
# 2   6  15  10  4  6  PSL(2,5)  D10  2^2    S6        2      2           12     1       2       true             false            false            true                                        complete  
# 3   6  15  10  4  6  PGL(2,5)  5:4  D8     S6        2      2           14     1       2       true             false            true             true                                        complete  
# 4   6  15  10  4  6  A6        A5   S4     S6        2      2           15     1       2       true             true             true             true                                        complete  
# 5   6  15  10  4  6  S6        S5   2xS4   S6        2      2           16     1       2       true             true             true             true                                        complete  
# 6   6  20  10  3  4  PGL(2,5)  5:4  S3     S6        2      2           14     1       1       true             false            true             true                 6                      complete  
# 7   6  20  10  3  4  A6        A5   3^2:2  S6        2      2           15     1       1       true             false            true             true                 7                      complete  
...
lD_6 :=  [
 rec( parameters := [ 6, 10, 5, 3, 2 ],
  autGroup := Group( [ (1,2,4,6,5), (1,2,5)(3,6,4) ] ),
