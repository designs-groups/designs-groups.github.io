...
# -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
# 1   6  10  5   3  2   A5  D10  S3       A5      2      2                  1        1       true             true             true                                              
# 2   6  15  10  4  6   A5  D10  2^2      S6      2      2                  1        2       true             false            false                                   complete  
# 3   6  20  10  3  4   A6  A5   (3^2):2  S6      2      2                  1        2       true             false            true             3                      complete  
# -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
# 1   6  10  5   3  2   A5  D10  S3       A5      2      2                  1        1       true             true             true                                              
# 2   6  15  10  4  6   A5  D10  2^2      S6      2      2                  1        2       true             false            false                                   complete  
# 3   6  15  10  4  6   S5  5:4  D8       S6      2      2                  1        1       true             false            true                                    complete  
# 4   6  20  10  3  4   S5  5:4  S3       S6      2      2                  1        2       true             false            true                                    complete  
# 5   6  15  10  4  6   A6  A5   S4       S6      2      2                  1        1       true             true             true                                    complete  
# 6   6  20  10  3  4   A6  A5   (3^2):2  S6      2      2                  1        2       true             false            true             6                      complete  
# 7   6  15  10  4  6   S6  S5   2xS4     S6      2      2                  1        1       true             true             true                                    complete  
# 8   6  20  10  3  4   S6  S5   S3xS3    S6      2      2                  1        2       true             false            true                                    complete  
# -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
# Orbit structure of point-stabiliser  1^{1}5^{1}  1^{1}5^{1}  
# Orbit structure of block-stabiliser  2^{3}       2^{3}       
# Point-transitive                     true        true        
# Block-transitive                     true        true        
...
lD_6 :=  [
 rec( parameters:= [ 6, 10, 5, 3, 2 ],
  autGroup := Group( [ (1,2,6,5,3), (1,3,2)(4,6,5) ] ),
