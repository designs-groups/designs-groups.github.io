...
# 3   7  21  9   3  3   7:3       3    1         7:6       3      2           3      1        2       true             false            false            false                                                                                            
# 4   7  14  6   3  2   7:6       6    3         7:6       2      2           4      1        1       true             false            true             false                5                                                                           
# 5   7  14  8   4  4   7:6       6    3         7:6       2      2           4      1        1       true             false            true             false                4                                                                           
# 6   7  21  12  4  6   7:6       6    2         7:6       2      2           4      1        2       true             false            false            false                                                                                            
# 7   7  28  12  3  4   PSL(3,2)  S4   S3        PSL(3,2)  2      2           5      1        2       true             false            true             false                8                                                                           
# 8   7  28  16  4  8   PSL(3,2)  S4   S3        PSL(3,2)  2      2           5      1        2       true             false            true             false                7                                                                           
# 9   7  35  15  3  5   A7        A6   (3xA4):2  S7        2      2           6      1        1       true             true             true             true                 10                     complete                                             
# 10  7  35  20  4  10  A7        A6   (3xA4):2  S7        2      2           6      1        1       true             true             true             true                 9                      complete                                             
# 11  7  21  15  5  10  S7        S6   2xS5      S7        2      2           7      1        2       true             true             true             true                                        complete                                             
# --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
# 15  7  7   3   3  1   PSL(3,2)  S4   S4        PSL(3,2)  2      2           5      1        1       true             true             true             true                 16          true       PG(2,2), Hadamard or Paley parameters                
# 16  7  7   4   4  2   PSL(3,2)  S4   S4        PSL(3,2)  2      2           5      1        1       true             true             true             true                 15          true       complement of PG(2,2), Hadamard or Paley parameters  
# 17  7  21  15  5  10  PSL(3,2)  S4   D8        S7        2      2           5      1        3       true             false            false            true                                        complete                                             
# 18  7  28  12  3  4   PSL(3,2)  S4   S3        PSL(3,2)  2      2           5      1        2       true             false            true             false                19                                                                          
# 19  7  28  16  4  8   PSL(3,2)  S4   S3        PSL(3,2)  2      2           5      1        2       true             false            true             false                18                                                                          
# 20  7  21  15  5  10  A7        A6   S5        S7        2      2           6      1        2       true             true             true             true                                        complete                                             
# 21  7  35  15  3  5   A7        A6   (3xA4):2  S7        2      2           6      1        1       true             true             true             true                 22                     complete                                             
# 22  7  35  20  4  10  A7        A6   (3xA4):2  S7        2      2           6      1        1       true             true             true             true                 21                     complete                                             
# 23  7  21  15  5  10  S7        S6   2xS5      S7        2      2           7      1        2       true             true             true             true                                        complete                                             
# 24  7  35  15  3  5   S7        S6   S4xS3     S7        2      2           7      1        1       true             true             true             true                 25                     complete                                             
# 25  7  35  20  4  10  S7        S6   S4xS3     S7        2      2           7      1        1       true             true             true             true                 24                     complete                                             
# --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
lD_7 :=  [
 rec( parameters := [ 7, 7, 3, 3, 1 ],
  autGroup := Group( [ (1,3,4)(2,7,6), (1,6,7,3,4,5,2) ] ),
 ...
 rec( parameters := [ 7, 21, 9, 3, 3 ],
  autGroup := Group( [ (1,4,7,5,6,2), (1,2)(3,7)(4,5), (1,4)(3,5)(6,7) ] ),
 ...
 rec( parameters := [ 7, 21, 12, 4, 6 ],
  autGroup := Group( [ (1,2,4,3,6,7,5), (1,4,7,5,6,2), (1,4)(3,5)(6,7) ] ),
  autSubgroup := Group( [ (1,2,4,3,6,7,5), (2,3,4,5,6,7) ] ),
  groupNumbers := [ 4, 1, 2 ],
  baseBlock := [ 3, 5, 6, 7 ],
  blockSizes := [ 4 ],
 ...
 rec( parameters := [ 7, 28, 12, 3, 4 ],
  autGroup := Group( [ (1,5,4)(2,6,7), (1,7,5)(3,4,6) ] ),
  autSubgroup := Group( [ (1,3,2)(4,7,5), (1,4)(6,7) ] ),
  groupNumbers := [ 5, 1, 2 ],
  baseBlock := [ 1, 2, 3 ],
  blockSizes := [ 3 ],
  isBinary := true,
...
lD_7_all :=  [
 ...
 rec( parameters := [ 7, 14, 8, 4, 4 ],
  ...
  v:= 7),
 rec( parameters := [ 7, 7, 3, 3, 1 ],
  autGroup := Group( [ (1,3,6,4)(2,5), (1,3,2)(4,7,5) ] ),
  autSubgroup := Group( [ (1,2,4,3,6,7,5), (2,4,6)(3,5,7) ] ),
  groupNumbers := [ 3, 1, 1 ],
  baseBlock := [ 1, 2, 3 ],
  blockSizes := [ 3 ],
 ...
 rec( parameters := [ 7, 21, 15, 5, 10 ],
  ...
  v:= 7),
 rec( parameters := [ 7, 7, 3, 3, 1 ],
  autGroup := Group( [ (1,3,6,2)(4,7), (1,2,4)(3,6,5) ] ),
  autSubgroup := Group( [ (1,3,2)(4,7,5), (1,4)(6,7) ] ),
  groupNumbers := [ 5, 1, 1 ],
  baseBlock := [ 1, 2, 4 ],
  blockSizes := [ 3 ],
