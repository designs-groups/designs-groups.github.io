...
lD := [ rec( autGroup := [ (3,5,6,7,4,8), (2,3)(5,8)(6,7), (1,2)(4,6)(5,8) ], 
        autStructures := [ "PSL(3,2) : C2", "PSL(3,2) : C2" ], autSubgroup := [ (1,2,3)(4,6,7), (2,4)(3,5)(7,8) 
    ...
    rec( autGroup := [ (1,3,8)(2,7,6)(4,5), (1,8,5,7,2,3) ], autStructures := [ "S8", "PSL(3,2) : C2" ], 
    ...
    rec( autGroup := [ (1,5,2)(4,8)(6,7), (1,6,3,4,7,5,8,2) ], autStructures := [ "S8", "PSL(3,2) : C2" ], 
