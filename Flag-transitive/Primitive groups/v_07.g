#I  number of primitive groups of degree 7: 7
...
# 3   7  7   4   4  2   PSL(3,2)  S4   S4        PSL(3,2)  2      2           5      1        1       true             true             true             true                             true       complement of PG(2,2), Hadamard or Paley parameters  
# 4   7  28  12  3  4   PSL(3,2)  S4   S3        PSL(3,2)  2      2           5      1        2       true             false            true             false                                                                                            
...
# 1   7  7   3   3  1   7:3       3    3         PSL(3,2)  3      2           3      1        1       true             true             true             false                            true       PG(2,2), Hadamard or Paley parameters                
# 2   7  14  6   3  2   7:6       6    3         7:6       2      2           4      1        1       true             false            true             false                                                                                            
# 3   7  7   3   3  1   PSL(3,2)  S4   S4        PSL(3,2)  2      2           5      1        1       true             true             true             true                 4           true       PG(2,2), Hadamard or Paley parameters                
# 4   7  7   4   4  2   PSL(3,2)  S4   S4        PSL(3,2)  2      2           5      1        1       true             true             true             true                 3           true       complement of PG(2,2), Hadamard or Paley parameters  
# 5   7  28  12  3  4   PSL(3,2)  S4   S3        PSL(3,2)  2      2           5      1        2       true             false            true             false                                                                                            
# 6   7  21  15  5  10  A7        A6   S5        S7        2      2           6      1        2       true             true             true             true                                        complete                                             
# 7   7  35  15  3  5   A7        A6   (3xA4):2  S7        2      2           6      1        1       true             true             true             true                 8                      complete                                             
# 8   7  35  20  4  10  A7        A6   (3xA4):2  S7        2      2           6      1        1       true             true             true             true                 7                      complete                                             
# 9   7  21  15  5  10  S7        S6   2xS5      S7        2      2           7      1        2       true             true             true             true                                        complete                                             
# 10  7  35  15  3  5   S7        S6   S4xS3     S7        2      2           7      1        1       true             true             true             true                 11                     complete                                             
# 11  7  35  20  4  10  S7        S6   S3xS4     S7        2      2           7      1        1       true             true             true             true                 10                     complete                                             
# --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
lD_7 :=  [
 rec( parameters := [ 7, 7, 3, 3, 1 ],
  autGroup := Group( [ (1,6,5,4,2,7,3), (1,2)(5,6) ] ),
 ...
 rec( parameters := [ 7, 7, 4, 4, 2 ],
  autGroup := Group( [ (1,2,5)(3,6,4), (1,5)(2,3,7,4) ] ),
 ...
 rec( parameters := [ 7, 28, 12, 3, 4 ],
  autGroup := Group( [ (1,2,3,7,6,4,5), (1,5)(2,3,7,4) ] ),
  autSubgroup := Group( [ (1,3,2)(4,7,5), (1,4)(6,7) ] ),
  groupNumbers := [ 5, 1, 2 ],
  baseBlock := [ 1, 2, 3 ],
  blockSizes := [ 3 ],
...
lD_7_all :=  [
 ...
 rec( parameters := [ 7, 14, 6, 3, 2 ],
  ...
  v:= 7),
 rec( parameters := [ 7, 7, 3, 3, 1 ],
  autGroup := Group( [ (1,2,7,4,6,5,3), (1,2)(3,6) ] ),
  autSubgroup := Group( [ (1,3,2)(4,7,5), (1,4)(6,7) ] ),
  groupNumbers := [ 5, 1, 1 ],
  baseBlock := [ 1, 2, 4 ],
  blockSizes := [ 3 ],
