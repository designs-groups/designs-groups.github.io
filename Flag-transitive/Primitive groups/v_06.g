...
# ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
# 1   6  10  5   3  2   A5  D10  S3       A5      2      2           1      1        1       true             true             true             true                                                  
# 2   6  15  10  4  6   A6  A5   S4       S6      2      2           3      1        2       true             true             true             true                                        complete  
# 3   6  20  10  3  4   A6  A5   (3^2):2  S6      2      2           3      1        1       true             false            true             true                 3                      complete  
# ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
# ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
# 1   6  10  5   3  2   A5  D10  S3       A5      2      2           1      1        1       true             true             true             true                                                  
# 2   6  15  10  4  6   S5  5:4  D8       S6      2      2           2      1        2       true             false            true             true                                        complete  
# 3   6  20  10  3  4   S5  5:4  S3       S6      2      2           2      1        1       true             false            true             true                 3                      complete  
# 4   6  15  10  4  6   A6  A5   S4       S6      2      2           3      1        2       true             true             true             true                                        complete  
# 5   6  20  10  3  4   A6  A5   (3^2):2  S6      2      2           3      1        1       true             false            true             true                 5                      complete  
# 6   6  15  10  4  6   S6  S5   2xS4     S6      2      2           4      1        2       true             true             true             true                                        complete  
# 7   6  20  10  3  4   S6  S5   S3xS3    S6      2      2           4      1        1       true             false            true             true                 7                      complete  
# ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
lD_6 :=  [
 rec( parameters := [ 6, 10, 5, 3, 2 ],
  autGroup := Group( [ (2,4)(5,6), (1,3,4,5,2) ] ),
  autSubgroup := Group( [ (1,2,5)(3,4,6), (3,5)(4,6) ] ),
  groupNumbers := [ 1, 1, 1 ],
  baseBlock := [ 1, 2, 3 ],
  blockSizes := [ 3 ],
  isBinary := true,
...
lD_6_all :=  [
 ...
 rec( parameters := [ 6, 15, 10, 4, 6 ],
  autGroup := Group( [ (1,2,3,4,5,6), (1,2) ] ),
  autSubgroup := Group( [ (3,6,5,4), (1,2,5)(3,4,6) ] ),
  groupNumbers := [ 2, 1, 2 ],
  baseBlock := [ 1, 2, 3, 4 ],
  blockSizes := [ 4 ],
  isBinary := true,
