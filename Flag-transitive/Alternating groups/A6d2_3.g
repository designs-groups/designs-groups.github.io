...
# ---------------------------------------------------------------------------------------------------------------------------------------------------------------
# 1   10  30   12  4  4   A6.2  (3^2):Q8  S4    (A6.2):2  2      2           23       18      true             false            2                                
# 2   10  30   18  6  10  A6.2  (3^2):Q8  S4    (A6.2):2  2      2           23       18      true             false            1                                
# 3   10  36   18  5  8   A6.2  (3^2):Q8  5:4   A6.2      2      2           23       17      true             true             3                                
# 4   10  45   36  8  28  A6.2  (3^2):Q8  QD16  S10       2      2           23       15      true             true                                              
# 5   10  120  36  3  8   A6.2  (3^2):Q8  S3    S10       2      2           23       8       true             false                                             
# 6   10  180  72  4  24  A6.2  (3^2):Q8  4     (A6.2):2  2      2           23       6       true             false                                             
# ---------------------------------------------------------------------------------------------------------------------------------------------------------------
...
lD := [ 
 rec(
  autGroup := Group( [ (1,2)(4,8)(5,9), (2,3)(4,6)(5,7)(8,9), ( 3, 4, 6, 5,10, 8, 7, 9), (4,5)(6,7)(8,9) ] ),
  autSubgroup := Group( [ ( 1, 2)( 3, 4, 7, 9,10, 8, 6, 5), (2,3)(4,6)(5,7)(8,9) ] ),
  baseBlock := [ 4, 5, 8, 9 ],
  blockSizes := [ 4 ],
  isBinary := true,
  isBlockDesign := true,
 ...
 rec(
  ...
  v := 10 ), 
 rec(
  autGroup := Group( [ (1,2)(4,9)(5,8)(6,7), (1,3)(4,5)(6,8)(7,9), ( 2, 4, 9, 3)( 6,10, 8, 7) ] ),
  autSubgroup := Group( [ ( 1, 2)( 3, 4, 7, 9,10, 8, 6, 5), (2,3)(4,6)(5,7)(8,9) ] ),
  baseBlock := [ 1, 2, 3, 4, 9 ],
  blockSizes := [ 5 ],
  isBinary := true,
