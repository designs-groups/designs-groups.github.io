...
# ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
# 1   6   15  10  4  6   A6  A5       S4       S6      2      2           21      18     true             true                                                                                  
# 2   6   20  10  3  4   A6  A5       (3^2):2  S6      2      2           21      16     true             false            2                                                                    
# 3   10  15  6   4  2   A6  (3^2):4  S4       S6      2      2           19      18     true             true             4                                                                    
# 4   10  15  9   6  5   A6  (3^2):4  S4       S6      2      2           19      18     true             true             3                                                                    
# 5   10  36  18  5  8   A6  (3^2):4  D10      A6.2    2      2           19      13     true             false            5                                                                    
# 6   10  60  18  3  4   A6  (3^2):4  S3       S6      2      2           19      10     true             false                                                                                 
# 7   15  15  8   8  4   A6  S4       S4       A8      3      2           18      18     true             true                         true       complement of PG(3,2) or Hadamard parameters  
# ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
lD := [ 
 ...
 rec(
  ...
  v := 6 ), 
 rec(
  autGroup := Group( [ ( 1, 2)( 3, 4)( 5,10), ( 2, 3)( 5, 6)( 9,10), (3,4)(6,7)(8,9), ( 3, 5)( 4,10)( 7, 9) ] ),
 ...
 rec(
  ...
  v := 10 ), 
 rec(
  autGroup := Group( [ ( 1, 2)( 5,10)( 6, 7)( 8, 9), ( 2, 3)( 5, 9)( 6,10)( 7, 8), ( 3, 4)( 5,10)( 6, 8)( 7, 9), ( 3, 5, 4,10)( 6, 7, 8, 9), ( 3, 6, 4, 8)( 5, 9,10, 7) ] ),
  autSubgroup := Group( [ ( 1, 9, 6, 3)( 2, 8, 4,10), ( 1, 2)( 5,10)( 6, 7)( 8, 9) ] ),
