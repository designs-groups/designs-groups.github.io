...
# -------------------------------------------------------------------------------------------------------------------------------------------------
# 1   5  10  6  3  3   A5  A4   S3  S5      2      2           8        6       true             true                                              
# 2   6  10  5  3  2   A5  D10  S3  A5      2      2           7        6       true             true             2                                
# -------------------------------------------------------------------------------------------------------------------------------------------------
...
lD := [ 
 rec(
  ...
  autSubgroup := Group( [ (1,3,5), (1,2)(3,4) ] ),
  baseBlock := [ 3, 4, 5 ],
  blockSizes := [ 3 ],
  isBinary := true,
  isBlockDesign := true,
  ...
  v := 5 ), 
 rec(
  autGroup := Group( [ (1,2)(5,6), (2,3)(4,5), (3,4)(5,6) ] ),
