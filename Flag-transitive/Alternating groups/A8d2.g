...
# 2   8   56    21   3   6   S8  S7                       S3xS5                    S8      2      2           294      289     true             true             3                                                         
# 3   8   56    35   5   20  S8  S7                       S3xS5                    S8      2      2           294      289     true             true             2                                                         
# 4   8   70    35   4   15  S8  S7                       S4xS4                    S8      2      2           294      284     true             false            4                                                         
# 5   35  35    18   18  9   S8  (((((2^4):3):2):3):2):2  (((((2^4):3):2):3):2):2  S8      3      3           290      290     true             true                         true       complement of Hadamard parameters  
# 6   56  1680  360  12  72  S8  S3xS5                    S4                       S8      4      4           289      155     true             false                                                                      
# 7   56  1680  360  12  72  S8  S3xS5                    S4                       S8      4      4           289      155     true             false                                                                      
# -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
lD := [ 
 ...
 rec(
  ...
  v := 8 ), 
 rec(
  autGroup := Group( [ ( 1, 2)( 6, 8)( 7, 9)(12,14)(13,15)(19,20)(22,24)(23,25)(29,30)(33,34), ( 2, 3)( 5, 6)( 9,10)(11,12)(15,16)(18,19)(21,22)(25,26)(28,29)(32,33), 
      ( 3, 4)( 6, 7)( 8, 9)(12,13)(14,15)(17,18)(22,23)(24,25)(27,28)(31,32), ( 3, 5)( 4,11)( 7,12)( 9,14)(10,17)(16,18)(21,35)(22,34)(23,30)(24,33)(25,29)(27,32), (11,21)(12,22)(13,23)(14,24)(15,25)(16,26)(17,27)
        (18,28)(19,29)(20,30) ] ),
  autSubgroup := Group( [ ( 1,21,31,35,20,10, 4)( 2,22,32,17,30,16, 7)( 3,23,11,27,34,19, 9)( 5,24,33,18, 8,26,13)( 6,25,12,28,14,29,15), ( 1,20)( 2,19)( 3,18)( 4,17)( 5,16)( 6,15)( 7,14)( 8,13)( 9,12)(10,11) ] ),
  baseBlock := [ 8, 9, 10, 14, 15, 16, 17, 18, 19, 24, 25, 26, 27, 28, 29, 31, 32, 33 ],
  blockSizes := [ 18 ],
  isBinary := true,
  isBlockDesign := true,
  isSimple := true,
 ...
 rec(
  ...
  baseBlock := [ 1, 2, 5, 11, 15, 21, 22, 25, 33, 36, 53, 55 ],
  blockSizes := [ 12 ],
  isBinary := true,
  isBlockDesign := true,
  isSimple := true,
 ...
 rec(
  ...
  autSubgroup := Group( [ ( 1, 2, 3, 5, 8,12,15)( 4, 7,11, 9,13,16,20)( 6,10,14,18,23,29,36)(17,22,28,35,37,43,48)(19,25,32,40,26,33,41)(21,27,34,42,46,53,56)(24,31,39,30,38,44,50)(45,52,54,51,47,55,49), 
      ( 2, 4)( 3, 6)( 5, 9)(13,17)(14,19)(16,21)(18,24)(20,26)(23,30)(29,37)(41,45)(42,47)(43,49)(44,51)(46,54) ] ),
  baseBlock := [ 3, 19, 20, 24, 28, 30, 31, 37, 38, 44, 49, 54 ],
  blockSizes := [ 12 ],
  isBinary := true,
  isBlockDesign := true,
  isSimple := true,
