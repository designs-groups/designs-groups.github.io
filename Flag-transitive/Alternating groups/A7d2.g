...
# ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
# 1   7   21   15  5   10  S7  S6     2xS5       S7      2      2           94       92      true             true                                                                       
# 2   7   35   15  3   5   S7  S6     S4xS3      S7      2      2           94       90      true             true             3                                                         
# 3   7   35   20  4   10  S7  S6     S4xS3      S7      2      2           94       90      true             true             2                                                         
# 4   21  70   30  9   12  S7  2xS5   (S3xS3):2  S7      3      3           92       85      true             false                                                                      
# 5   21  252  60  5   12  S7  2xS5   D20        S7      3      3           92       54      true             false                                                                      
# 6   35  35   18  18  9   S7  S4xS3  S4xS3      S8      4      3           90       90      true             true                         true       complement of Hadamard parameters  
# ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
lD := [ 
 ...
 rec(
  ...
  v := 7 ), 
 rec(
  autGroup := Group( [ ( 1, 2)( 3, 5)( 6,19)(15,21)(17,18), ( 2, 3, 7,20, 4,19)( 5, 8, 6)( 9,11,21)(10,15)(12,18,16)(13,17), ( 6,21)( 7,10)( 8, 9)(12,14)(15,19), 
      ( 3,19)( 4, 7)( 5, 6)( 9,11)(12,16), ( 3,19)( 4, 7)( 5, 6)( 9,12)(10,13)(11,16)(15,17)(18,21) ] ),
  autSubgroup := Group( [ ( 1, 2, 4, 7,10,13)( 3, 6, 9,12,15,18)( 5, 8,11,14,17,20)(16,19,21), ( 1, 3)( 2, 5)( 7, 8)( 9,10)(13,16) ] ),
  baseBlock := [ 2, 5, 6, 9, 10, 11, 12, 13, 16 ],
  blockSizes := [ 9 ],
  isBinary := true,
  isBlockDesign := true,
  isSimple := true,
