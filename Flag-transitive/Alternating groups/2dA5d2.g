...
# 5   15  15  8   8  4   S5  D8   D8   A8      4      2           false            false                        true     complement of PG(3,2), Hadamard parameters             
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------
...
lD := [ 
 ...
 rec(
  ...
  autSubgroup := Group( [ (1,2,4,3), (1,2)(3,5)(4,6) ] ),
  baseBlock := [ 1, 2, 3, 5 ],
  blockSizes := [ 4 ],
  isBinary := true,
  isBlockDesign := true,
 ...
 rec(
  ...
  v := 10 ), 
 rec(
  autGroup := Group( [ ( 1, 2)( 7,11)( 9,15)(10,14), ( 2, 3)( 7,13)( 8,10)(12,15), ( 2, 4)( 3,11)( 6,15)(12,14), ( 4, 5)( 7,15)( 9,11)(12,13), ( 5, 6)( 8,12)( 9,14)(10,15), 
      ( 5, 8)( 6,12)( 9,10)(14,15), ( 5, 9)( 6,14)( 8,10)(12,15) ] ),
  autSubgroup := Group( [ ( 1, 4, 7,10)( 2, 5, 8,11)( 3, 6, 9,12)(13,15), ( 2, 3)( 4, 6)( 7, 8)(10,13)(11,14)(12,15) ] ),
  baseBlock := [ 4, 6, 7, 8, 10, 11, 13, 14 ],
  blockSizes := [ 8 ],
  isBinary := true,
  isBlockDesign := true,
  isSimple := true,
