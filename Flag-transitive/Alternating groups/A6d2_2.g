...
# -------------------------------------------------------------------------------------------------------------------------------------------------------------
# 1   10  30   12  4  4   A6:2  (3^2):8  S4   (A6:2):2  2      2           24       21      true             false            2                                
# 2   10  30   18  6  10  A6:2  (3^2):8  S4   (A6:2):2  2      2           24       21      true             false            1                                
# 3   10  45   36  8  28  A6:2  (3^2):8  D16  S10       2      2           24       18      true             true                                              
# 4   10  72   36  5  16  A6:2  (3^2):8  D10  (A6:2):2  2      2           24       16      true             false            4                                
# 5   10  120  36  3  8   A6:2  (3^2):8  S3   S10       2      2           24       9       true             false                                             
# 6   10  180  72  4  24  A6:2  (3^2):8  2^2  (A6:2):2  2      2           24       7       true             false                                             
# -------------------------------------------------------------------------------------------------------------------------------------------------------------
...
lD := [ 
 rec(
  autGroup := Group( [ (1,2)(5,6)(8,9), ( 2, 3)( 6,10)( 7, 8), ( 3, 4)( 5, 6)( 7,10)( 8, 9), ( 3, 5, 4, 6)( 7, 8,10, 9), ( 5, 9)( 6, 8)( 7,10) ] ),
  autSubgroup := Group( [ ( 2, 3, 4)( 5, 7, 8)( 6, 9,10), ( 1, 2)( 3, 5)( 4, 6)( 7, 8)( 9,10) ] ),
  baseBlock := [ 5, 6, 8, 9 ],
  blockSizes := [ 4 ],
  isBinary := true,
  isBlockDesign := true,
