...
# #####################################################################################################
# Remark: all designs 
#         lD_L211d2 is the list of the designs
...
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
# 1   12  66   55   10  45  PSL(2,11):2  11:10  D20  S12          2      2                  3       9       true             true             true             true                                        complete
# 2   12  110  55   6   25  PSL(2,11):2  11:10  D12  PSL(2,11):2  2      2                  3       11      true             false            true             true                 2
# 3   12  132  55   5   20  PSL(2,11):2  11:10  D10  PSL(2,11):2  2      2                  3       15      true             false            true             false
# 4   12  165  55   4   15  PSL(2,11):2  11:10  D8   PSL(2,11):2  2      2                  3       18      true             false            true             true                 5
# 5   12  165  110  8   70  PSL(2,11):2  11:10  D8   PSL(2,11):2  2      2                  3       18      true             false            true             true                 4
# 6   12  220  55   3   10  PSL(2,11):2  11:10  S3   S12          2      2                  3       21      true             false            true             false                                       complete
# 7   12  220  110  6   50  PSL(2,11):2  11:10  S3   PSL(2,11):2  2      2                  3       20      true             false            true             true                 7
# 8   12  330  110  4   30  PSL(2,11):2  11:10  2^2  PSL(2,11):2  2      2                  3       25      true             false            true             false
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
lD_L211d2 :=  [
 rec(
  ...
  autSubgroup := Group( [ ( 1, 2, 3)( 4, 5, 6)( 7, 9,11)( 8,10,12), ( 1, 2)( 3, 4)( 5, 7)( 6, 8)(10,12) ] ),
  groupNumbers := [ " ", 3, 9 ],
  ...
  v := 12 ), 
 rec(
  autGroup := Group( [ ( 1, 2)( 4, 7)( 5,11)( 6, 9)( 8,10), ( 2, 3)( 4,11)( 5, 9)( 6, 7)(10,12), ( 3, 4, 5,11, 7)( 6, 9, 8,12,10), ( 3, 6, 7,10,11,12, 5, 8, 4, 9) ] ),
  autSubgroup := Group( [ ( 1, 2, 3)( 4, 5, 6)( 7, 9,11)( 8,10,12), ( 1, 2)( 3, 4)( 5, 7)( 6, 8)(10,12) ] ),
  groupNumbers := [ " ", 3, 11 ],
  baseBlock := [ 1, 2, 5, 7, 9, 11 ],
  blockSizes := [ 6 ],
  isBinary := true,
  isBlockDesign := true,
  isSimple := true,
...
for D in lD_L211d2 do D.blocks := Set( Orbit( D.autSubgroup , D.baseBlock , OnSets ) ); od; 
