...
# ------------------------------------------------------------------------------------------------------------------------------------------------------
# 1   12  66   55   10  45  PSL(2,11):2  11:10  D20  S12          2      2           true             true                                              
# 2   12  110  55   6   25  PSL(2,11):2  11:10  D12  PSL(2,11):2  2      2           true             false            2                                
# 3   12  132  55   5   20  PSL(2,11):2  11:10  D10  PSL(2,11):2  2      2           true             false                                             
# 4   12  165  55   4   15  PSL(2,11):2  11:10  D8   PSL(2,11):2  2      2           true             false            5                                
# 5   12  165  110  8   70  PSL(2,11):2  11:10  D8   PSL(2,11):2  2      2           true             false            4                                
# 6   12  220  55   3   10  PSL(2,11):2  11:10  S3   S12          2      2           true             false                                             
# 7   12  220  110  6   50  PSL(2,11):2  11:10  S3   PSL(2,11):2  2      2           true             false            7                                
# 8   12  330  110  4   30  PSL(2,11):2  11:10  2^2  PSL(2,11):2  2      2           true             false                                             
# ------------------------------------------------------------------------------------------------------------------------------------------------------
...
lD := [ 
 rec(
  ...
  autSubgroup := Group( [ ( 1, 2, 3)( 4, 5, 6)( 7, 9,11)( 8,10,12), ( 3, 4)( 5, 7)( 6, 8)( 9,11)(10,12) ] ),
  ...
  v := 12 ), 
 rec(
  autGroup := Group( [ ( 1, 2)( 5, 6)( 7, 8)( 9,12)(10,11), ( 2, 3)( 4, 6)( 7,12)( 8,11)( 9,10), ( 3, 4)( 5, 7)( 6, 8)( 9,11)(10,12), ( 3, 5,11,12, 8, 4, 7, 9,10, 6) ] ),
  autSubgroup := Group( [ ( 1, 2, 3)( 4, 5, 6)( 7, 9,11)( 8,10,12), ( 3, 4)( 5, 7)( 6, 8)( 9,11)(10,12) ] ),
  baseBlock := [ 1, 2, 8, 10, 11, 12 ],
  blockSizes := [ 6 ],
  isBinary := true,
  isBlockDesign := true,
  isSimple := true,
