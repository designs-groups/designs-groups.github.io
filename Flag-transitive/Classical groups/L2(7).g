...
# -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
# 1   7  7   3   3  1   PSL(3,2)  S4   S4  PSL(3,2)  2      2                                  true             true             true             true                 2           true       PG(2,2), Hadamard or Paley parameters                
# 2   7  7   4   4  2   PSL(3,2)  S4   S4  PSL(3,2)  2      2                                  true             true             true             true                 1           true       complement of PG(2,2), Hadamard or Paley parameters  
# 3   7  28  12  3  4   PSL(3,2)  S4   S3  PSL(3,2)  2      2                                  true             false            true             false                                                                                            
# 4   8  14  7   4  3   PSL(2,7)  7:3  A4  ASL(3,2)  2      2                                  true             false            true             true                 4                                                                           
# 5   8  28  21  6  15  PSL(2,7)  7:3  S3  S8        2      2                                  true             false            true             true                                        complete                                             
# 6   8  42  21  4  9   PSL(2,7)  7:3  4   PGL(2,7)  2      2                                  true             false            true             true                 6                                                                           
# 7   8  56  21  3  6   PSL(2,7)  7:3  3   S8        2      2                                  true             false            true             false                                       complete                                             
# -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
lD_L32 :=  [
 rec( parameters := [ 7, 7, 3, 3, 1 ],
  autGroup := Group( [ (1,6,5,7,4,3,2), (1,7,2)(4,5,6) ] ),
 ...
 rec( parameters := [ 7, 7, 4, 4, 2 ],
  autGroup := Group( [ (2,3,5,4)(6,7), (1,5,2)(4,7,6) ] ),
  autSubgroup := Group( [ (1,2,3)(4,5,6), (3,4)(6,7) ] ),
  groupNumbers := [ " ", " ", " " ],
  baseBlock := [ 3, 4, 6, 7 ],
  blockSizes := [ 4 ],
 ...
 rec( parameters := [ 7, 28, 12, 3, 4 ],
  autGroup := Group( [ (1,3,7,6,2,4,5), (1,4,5,3,6,7,2) ] ),
  autSubgroup := Group( [ (1,2,3)(4,5,6), (3,4)(6,7) ] ),
  groupNumbers := [ " ", " ", " " ],
  baseBlock := [ 4, 5, 7 ],
  blockSizes := [ 3 ],
 ...
 rec( parameters := [ 8, 14, 7, 4, 3 ],
  autGroup := Group( [ (2,8,4)(3,5,7), (1,6,5,7,2,4,8) ] ),
